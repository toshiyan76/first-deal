  ...
  const handleToggle = (checked: boolean) => {
    ...
    if (checked && switchRef.current) {
      ...
      confetti({
        ...
        colors: ["#ffffff", "#60a5fa", "#93c5fd", "#3b82f6"],
        ticks: 200,
        gravity: 1.2,
        decay: 0.94,
        startVelocity: 30,
  ...
  return (
    <div className="container py-20">
      <div className="text-center space-y-4 mb-12">
        ...
        <p className="text-lg whitespace-pre-line text-blue-100">
          {description}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 sm:2 gap-4">
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              `rounded-2xl border-[1px] p-6 bg-white text-gray-900 text-center lg:flex lg:flex-col lg:justify-center relative`,
              plan.isPopular ? "border-blue-600 border-2" : "border-gray-200",
              "flex flex-col",
              !plan.isPopular && "mt-5",
              index === 0 || index === 2
              ...
              <div className="mt-8">
                <Link
                  ...
                  className={cn(
                    ...
                    "transform-gpu ring-offset-current transition-all duration-300 ease-out hover:ring-2 hover:ring-blue-600 hover:ring-offset-1",
                    plan.isPopular
